...
public class LiquibaseBuildDefinition extends AbstractBuildDefinition {
    ...
    public LiquibaseBuildDefinition(String name, DatabaseProperties databaseProperties, String changeLogFile) {
        super(name);
        this.databaseProperties = databaseProperties;
        this.changeLogFile = changeLogFile;
    }

    public LiquibaseBuildDefinition(BuildPriority priority, String name, DatabaseProperties databaseProperties, String changeLogFile) {
        super(priority, name);
        this.databaseProperties = databaseProperties;
        this.changeLogFile = changeLogFile;
    }
