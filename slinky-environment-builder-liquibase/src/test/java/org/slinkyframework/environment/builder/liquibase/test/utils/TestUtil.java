...
public class TestUtil {
    ...
    public static final String TEST_SID = "XE";
    ...
    public static final OracleProperties createOracleProperties() {
        return new OracleProperties(TEST_USERNAME, TEST_PASSWORD, TEST_PORT, TEST_SID, Arrays.asList(TEST_USER1, TEST_USER2));
    }
    ...
    public static final OracleProperties createOraclePropertiesWithUser(String user) {
        return new OracleProperties(TEST_USERNAME, TEST_PASSWORD, TEST_PORT, TEST_SID, Arrays.asList(user));
    }
    ...
    public static final OracleProperties createOraclePropertiesWithTablespace(String tablespace) {
        return new OracleProperties(TEST_USERNAME, TEST_PASSWORD, TEST_PORT, TEST_SID, Arrays.asList(TEST_USER1, TEST_USER2), Arrays.asList(tablespace));
    }
}
